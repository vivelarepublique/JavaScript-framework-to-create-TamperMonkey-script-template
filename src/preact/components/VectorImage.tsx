...
export default function VectorImage() {
    return (
        <Fragment>
            <div>
                <p class='framework-test-header-preact'>Preact Test Vector Image</p>
                <div class='container-fluid text-center'>
                    <div class='row'>
                        <div class='col-12'>
                            <img src={preactLogo} class='framework-test-large-logo framework-test-rotate-logo' alt='Preact logo' />
                        </div>
                    </div>
                </div>
                <div class='container-fluid text-center'>
